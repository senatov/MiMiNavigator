...
| `CloudLinkShortener` | Shared Google Drive/Dropbox shortener using `mimiNavi_` + 14 random Base62 characters |
...
- Short aliases must remain `mimiNavi_` + 14 random Base62 characters
