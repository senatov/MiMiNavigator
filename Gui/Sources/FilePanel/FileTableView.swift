        ...
        return ScrollView {
            VStack(spacing: 0) {
                ...
                HStack(spacing: 8) {
                    ...
                    .onTapGesture {
                        if sortKey == .name { sortAscending.toggle() } else { sortKey = .name; sortAscending = true }
                    }
                    ...
                    .contentShape(Rectangle())
                    .onTapGesture {
                        if sortKey == .size { sortAscending.toggle() } else { sortKey = .size; sortAscending = true }
                    }
                    ...
                    .contentShape(Rectangle())
                    .onTapGesture {
                        if sortKey == .date { sortAscending.toggle() } else { sortKey = .date; sortAscending = true }
                    }
                }
                .padding(.vertical, 4)
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        HStack(alignment: .center, spacing: 8) {
                            ...
                            FileRowView(file: file, isSelected: isSel) {
                                    // Selection handled by parent HStack highPriorityGesture
                            }
                            .frame(maxWidth: .infinity, alignment: .leading)
