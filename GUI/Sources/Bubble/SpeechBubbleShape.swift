...
// MARK: - Speech bubble with configurable tail direction and offset along the edge.
public struct SpeechBubbleShape: Shape {
    ...
    // MARK: - Animate tail offset smoothly
    ...
    public func path(in rect: CGRect) -> Path {
        ...
        // MARK: - Helpers to clamp along top/bottom (horizontal) or left/right (vertical) edges
        ...
        // MARK: - Tail base center point on the body edge
        ...
        p.addQuadCurve(
            to: CGPoint(x: body.maxX - r, y: body.maxY),
