    ...
    private struct TooltipBubble: View {
        ...
        var body: some View {
            Text(text)
                ...
                .clipShape(RoundedRectangle(cornerRadius: FilePanelStyle.toolbarButtonRadius, style: .continuous))
                .overlay(
                    RoundedRectangle(cornerRadius: FilePanelStyle.toolbarButtonRadius)
