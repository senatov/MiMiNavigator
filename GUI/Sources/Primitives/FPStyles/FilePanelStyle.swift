...
enum FilePanelStyle {
    ...
    static let toolbarBackgroundTint = Color.black.opacity(0.05)
    static let toolbarStrokeOuter = Color.white.opacity(0.08)
    static let toolbarStrokeInner = Color.white.opacity(0.04)
