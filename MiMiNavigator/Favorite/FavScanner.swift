...
class FavScanner {
    ...
    private var currentDepth: Int = 0
        ...
        /// Scans both favorite directories and mounted network volumes
    func scanFavoritesAndNetworkVolumes() -> [CustomFile] {
        ...
        roots.append(contentsOf: FileManager.default.allDirectories)
            ...
            // Add mounted volumes
        let mounted = try? provider.contentsOfDirectory(path: "/Volumes", completionHandler: nil)
        ...
        let trees = roots.compactMap { buildFavTreeStructure(at: $0) }
