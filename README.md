...
<p align="center">
  ...
  <a href="https://github.com/senatov/MiMiNavigator/releases/tag/v0.9.9.7.5"><img src="https://img.shields.io/badge/release-v0.9.9.7.5-orange" alt="Release v0.9.9.7.5"></a>
</p>
...
Browse two locations side by side and copy, move, rename, organize, or inspect files with the keyboard or mouse. Tabs, paths, history, selections, and List, Preview, or Tree views remain available between sessions. A persistent resizable Preview pane can follow the active selection without replacing either working panel.
...
1. [Download MiMiNavigator v0.9.9.7.5](https://github.com/senatov/MiMiNavigator/releases/tag/v0.9.9.7.5).
