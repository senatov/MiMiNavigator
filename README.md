...
- 	**Views** — SwiftUI views for file panels, the top menu bar, and the bottom command panel. **DuoFilePanelView** represents only the bottom command button bar, similar to the one in Total Commander, with buttons for actions like "View", "Edit", "Copy", "Move", "Delete", and more.
...
* a1566d6 - Senatov  scroll & Tab - works (4 weeks ago, 2025-10-03 20:03:38 +0200)
* 759bb22 - Senatov  before reconfig (4 weeks ago, 2025-10-03 19:30:32 +0200)
* f725cd5 - Senatov  yet better  fixed scrolling + tabbing (4 weeks ago, 2025-10-03 10:43:21 +0200)
* 12aa0e4 - Senatov  tmp (ver) (4 weeks ago, 2025-10-02 19:37:49 +0200)
